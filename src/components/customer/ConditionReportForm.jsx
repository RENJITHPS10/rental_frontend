...
import { submitConditionReportAPI } from '../../api/bookings';
...
const ConditionReportForm = () => {
  ...
  const mutation = useMutation({
    mutationFn: (conditionData) => submitConditionReportAPI(bookingId, conditionData),
  ...
  return (
    <div className="max-w-md mx-auto p-4 bg-white shadow-md rounded">
      <h2 className="text-2xl font-bold mb-4">Condition Report</h2>
